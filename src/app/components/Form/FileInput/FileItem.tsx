...
import { complex, progress } from "framer-motion";
...
const fileItem = tv({
  slots: {
    ...
    icon: "rounded-full border-4 bg-violet-100 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500",
    deleteButton: "",
  },
  ...
  variants: {
    state: {
      ...
      complete: { container: "border-violet-500 dark:border-violet-400/30" },
      error: {
        container:
